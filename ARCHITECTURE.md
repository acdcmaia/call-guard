...
- **fix:** durante `CHECKING`, o ícone de refresh é substituído por `CircularProgressIndicator` (24 dp, `strokeWidth` 2 dp) e o botão fica desabilitado; texto exibido sem reticências
